...
def init_args():
    ...
    parser.add_argument('--drc_flag', default='False', help='drcmodel work or skip, False is skip, True is work')
    ...
    parser.add_argument('--crnn_mode', type=str, default="None", help='None or inference(default)')
...
if __name__ == '__main__':
    ...
    try:
        ...
        # for img_path in (get_file_list(args.input_folder, p_postfix=['.jpg'])): 
            ...
            count += 1
        tEnd = time.time() # 計時結束
        log.logger.info('job finished. page count {}, cost time {:.2f} sec'.format(count, (tEnd - tStart)))
    except:
